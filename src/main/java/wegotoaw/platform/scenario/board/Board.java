...
import wegotoaw.data.wrappers.scenario.Cell;
...
public final class Board implements ModelProvider<BoardModel> {
    ...
    public Board(wegotoaw.data.wrappers.scenario.Scenario scenario) {
        wegotoaw.data.wrappers.scenario.Map sourceMap = scenario.getMap();
    ...
    public void initialize(wegotoaw.data.wrappers.scenario.Scenario scenarioXML, Scenario scenario, Force[] forces) {
        wegotoaw.data.wrappers.scenario.Map sourceMap = scenarioXML.getMap();
        for (Cell cell : sourceMap.getCell()) {
            int x = cell.getX();
            int y = cell.getY();
