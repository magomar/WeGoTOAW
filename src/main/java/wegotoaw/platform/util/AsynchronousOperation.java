...
public abstract class AsynchronousOperation<T>
    ...
    /**
     * This method is invoked on the event thread when the operation completes, <em>regardless of whether it succeeded
     * or failed</em>. It exists so that subclasses can manage user feedback (such as resetting a busy cursor).
     */
