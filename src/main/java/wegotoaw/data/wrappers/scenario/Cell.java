...
@XmlType(name = "Cell", namespace = "wegotoaw", propOrder = {
        "terrain",
        "feature",
        "entrenchment",
        "distance",
...
public class Cell {
    ...
    @XmlElement(name = "Terrain", namespace = "wegotoaw")
    protected List<Terrain> terrain;
    @XmlElement(name = "Feature", namespace = "wegotoaw")
    protected List<TerrainFeature> feature;
    @XmlElement(name = "Entrenchment", namespace = "wegotoaw")
    protected Integer entrenchment;
    @XmlElement(name = "Distance", namespace = "wegotoaw")
    protected Integer distance;
    @XmlElement(name = "Owner", namespace = "wegotoaw")
    protected int owner;
    @XmlElement(name = "VP", namespace = "wegotoaw")
