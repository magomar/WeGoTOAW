...
@XmlType(name = "Orders", namespace = "wegotoaw", propOrder = {
        "operationalStance",
        "activates",
        "frontage",
        "onlyPO",
...
public class Orders {
    ...
    @XmlElement(name = "OperationalStance", namespace = "wegotoaw", required = true)
    protected OperationalStance operationalStance;
    @XmlElement(name = "Activates", namespace = "wegotoaw", defaultValue = "0")
    protected int activates;
    @XmlElement(name = "Frontage", namespace = "wegotoaw", required = true, defaultValue = "NORMAL")
    protected Frontage frontage;
    @XmlElement(name = "OnlyPO", namespace = "wegotoaw", defaultValue = "false")
    protected boolean onlyPO;
    @XmlElement(name = "Emphasis", namespace = "wegotoaw", required = true)
    protected Emphasis emphasis;
    @XmlElement(name = "Supportscope", namespace = "wegotoaw", required = true)
    protected SupportScope supportscope;
    @XmlElement(name = "Track", namespace = "wegotoaw", required = true)
