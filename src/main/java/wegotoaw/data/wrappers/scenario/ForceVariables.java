...
@XmlType(name = "ForceVariables", namespace = "wegotoaw", propOrder = {
        "force"
})
public class ForceVariables {
    ...
    public static class Force {
        ...
        @XmlElement(name = "ZOCCost", namespace = "wegotoaw", defaultValue = "100")
