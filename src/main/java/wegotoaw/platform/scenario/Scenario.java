...
public final class Scenario implements ModelProvider<ScenarioModel> {
    ...
    public Scenario(wegotoaw.data.wrappers.scenario.Scenario scenario, EquipmentDB eqpDB) {
        ...
        Collection<wegotoaw.data.wrappers.scenario.Force> scenForces = oob.getForce();
        forces = new Force[scenForces.size()];
        for (wegotoaw.data.wrappers.scenario.Force force : oob.getForce()) {
