 ...
 */
public class JTexturedPanel extends JPanel {
     ...
     */
    public JTexturedPanel(Color foreground, Color background) {
        super();
     ...
     */
    public JTexturedPanel(Color foreground, Color background, boolean[][] texture) {
        super();
        ourDefaultForeground = (foreground != null ? foreground : Color.white);
        ourDefaultBackground = (background != null ? background : getBackground());
     ...
     * texture map and consisting of the given foreground and background colors.
     */
    public JTexturedPanel(Color foreground, Color background, boolean[][] texture, int scale) {
        super();
        ourDefaultForeground = (foreground != null ? foreground : Color.white);
        ourDefaultBackground = (background != null ? background : getBackground());
     ...
     */
    public JTexturedPanel(Image texture) {
        super();
        ourDefaultForeground = Color.white;
        ourDefaultBackground = getBackground();
     ...
     */
    public JTexturedPanel(Icon textureIcon) {
        super();
        ourDefaultForeground = Color.white;
        ourDefaultBackground = getBackground();
