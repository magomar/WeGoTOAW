...
@XmlType(name = "Header", namespace = "wegotoaw", propOrder = {
        "name",
        "description",
        "forceName",
        "outcomesWin",
...
public class Header {
    ...
    @XmlElement(name = "Description", namespace = "wegotoaw", required = true)
    protected String description;
    @XmlElement(name = "ForceName", namespace = "wegotoaw", required = true)
    protected List<String> forceName;
    @XmlElement(name = "OutcomesWin", namespace = "wegotoaw", required = true)
    protected List<String> outcomesWin;
    @XmlElement(name = "OutcomesLose", namespace = "wegotoaw", required = true)
    protected List<String> outcomesLose;
    @XmlElement(name = "OutcomesDraw", namespace = "wegotoaw", required = true)
