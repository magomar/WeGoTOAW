...
import wegotoaw.data.wrappers.scenario.*;
import wegotoaw.platform.engine.command.operational.plans.OperationalPlan;
import wegotoaw.platform.engine.command.operational.plans.OperationalStance;
...
public class ProgrammedOpponent {
    ...
    public OperationalPlan obtainOperationalPlan(Formation formation) {
        ...
        return operationalStance.buildOperationalPlan(formation, objectives, emphasis, supportscope);
    }
