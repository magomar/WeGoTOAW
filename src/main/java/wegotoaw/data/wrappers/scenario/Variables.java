...
@XmlType(name = "Variables", namespace = "wegotoaw", propOrder = {
        "scenarioIsOver",
        "ceaseFire",
        "eventEngineVariable",
        "riversAlongEdges",
...
public class Variables {
    ...
    @XmlElement(namespace = "wegotoaw", defaultValue = "10")
    protected int attritionDivider;
    @XmlElement(namespace = "wegotoaw", defaultValue = "99")
    protected int maxRoundsPerBattle;
    @XmlElement(name = "AAALethalityRate", namespace = "wegotoaw", defaultValue = "100")
