...
@XmlType(name = "Map", namespace = "wegotoaw", propOrder = {
        "maxX",
        "maxY",
        "cell",
        "place"
...
public class Map {
    ...
    @XmlElement(name = "MaxX", namespace = "wegotoaw")
    protected int maxX;
    @XmlElement(name = "MaxY", namespace = "wegotoaw")
    protected int maxY;
    @XmlElement(name = "Cell", namespace = "wegotoaw", required = true)
    protected List<Cell> cell;
    @XmlElement(name = "Place", namespace = "wegotoaw")
